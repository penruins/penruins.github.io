import{_ as a,c as n,o as e,aj as p}from"./chunks/framework.Cjb08o0w.js";const h=JSON.parse('{"title":"docker","description":"","frontmatter":{"title":"docker"},"headers":[],"relativePath":"computer-science/CI-CD/docker.md","filePath":"computer-science/CI-CD/docker.md"}'),l={name:"computer-science/CI-CD/docker.md"};function c(i,s,t,r,d,o){return e(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="docker" tabindex="-1">docker <a class="header-anchor" href="#docker" aria-label="Permalink to “docker”">​</a></h1><h2 id="常用操作命令" tabindex="-1">常用操作命令 <a class="header-anchor" href="#常用操作命令" aria-label="Permalink to “常用操作命令”">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># centos 操作系统环境下</span></span>
...
<span class="line"><span>sudo systemctl restart docker</span></span></code></pre></div>`,5)])])}const m=a(l,[["render",c]]);export{h as __pageData,m as default};
